...
# constants
function acp {
    # archivechannelsparameters="/path/to/your/archivechannels.v6.sh -E -m [-o] \"$sourceguildid/[insert_channel_id_here]\" \"$sourceauth\" /path/to/your/conf/file.conf \"$guildfilename.[insert_channel_name_here].$(date +%y.%m.%d).json\"" # just an example, you need to change it to fit your own needs
    threshold=20
}
    ...
    do
        ...
        then
            ...
            then
                ...
                echo "# channel name: #$name, messages: $totalresults" >> "$guildfilename.queue.sh"
