...
avatarurl_defaults="https://cdn.discordapp.com/emojis/680083496789606422.png"
        ...
        then
            ...
            then
                ...
                do
                    ...
                    [ "$dir" ] && echo " dir=downloaded/$dir" >> "/tmp/damned/$exportfilename.part$processid" || echo " dir=downloaded" >> "/tmp/damned/$exportfilename.part$processid"
...
function upload_subprocess2 { # for remote url
    ...
    echo -e "\e[36m$discordlink\e[0m uploaded by process \e[36m$processid\e[0m"
    echo "$discordlink" >> "/tmp/damned/$exportfilename.part$processid"
    echo " dir=downloaded" >> "/tmp/damned/$exportfilename.part$processid"
...
function upload_subprocess3 { # for rclone
    ...
    then
        echo " dir=downloaded" >> "/tmp/damned/$exportfilename.part$processid"
        echo " out=$filename.part$partnum" >> "/tmp/damned/$exportfilename.part$processid"
    else
        local dir="${filename%/*}"
        local filename2="${filename##*/}"
        echo " dir=downloaded/$dir" >> "/tmp/damned/$exportfilename.part$processid"
        echo " out=$filename2.part$partnum" >> "/tmp/damned/$exportfilename.part$processid"
    fi
    sleep $sleeptime
}
...
function batgeneration() {
    ...
    then
        ...
        echo "pause > nul" >> "$batfilename"
        echo "cd downloaded" >> "$batfilename"
        cat /tmp/damned/temp.bat >> "$batfilename"
...
function scheduler4 { # muptiple threads for rclone files
    ...
    do
        ...
        echo "$combine" >> /tmp/damned/temp.bat
    done
